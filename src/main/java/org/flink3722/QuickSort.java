...
public final class QuickSort implements IndexedSorter {
	 ...
	 */
	private static void fix(NormalizedKeySorter s, int pN, int pO, int rN, int rO) {
	 ...
	 */
	public void sort(final NormalizedKeySorter s, int p, int r) {
	...
	public void sort(NormalizedKeySorter s) {
		sort(s, 0, s.size());
	}
	 ...
	 *
	 * @see #sort(NormalizedKeySorter, int, int)
	 */
	private static void sortInternal(final NormalizedKeySorter s, int recordsPerSegment, int recordSize, int maxOffset,
	...
	@Override
	public void sort(IndexedSortable indexedSortable, int i, int j) {
		sort((NormalizedKeySorter) indexedSortable, i, j);
	}

	@Override
	public void sort(IndexedSortable indexedSortable) {
		sort((NormalizedKeySorter) indexedSortable);
	}
}
