...
/**
 * Created by heytitle on 12/26/16.
 */
...
@Internal
public final class MyLongComparator extends BasicTypeComparator<Long> {

	private static final long serialVersionUID = 1L;


	public MyLongComparator(boolean ascending) {
		super(ascending);
	}
	...
	@Override
	public MyLongComparator duplicate() {
		return new MyLongComparator(ascendingComparison);
	}
}
